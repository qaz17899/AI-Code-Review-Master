  ...
  return (
    <div className="w-full h-screen flex flex-col">
       ...
       <header className="relative overflow-hidden flex-shrink-0 p-2 sm:p-4 border-b border-[var(--accent-color)]/20 flex justify-between items-center bg-stone-100/75 dark:bg-[#10141c]/75 backdrop-blur-2xl sticky top-0 z-20 dark:ring-1 dark:ring-inset dark:ring-white/10 transition-all duration-500 glass-noise">
            ...
            <div className="hidden lg:flex items-center gap-4 bg-stone-200 dark:bg-slate-800/50 border border-stone-300 dark:border-slate-700/50 px-4 py-1.5 rounded-full shadow-inner dark:shadow-black/20">
                ...
                <div className="flex items-baseline gap-1.5 text-sm pl-4 border-l border-stone-400 dark:border-slate-600">
                ...
                <div className="flex items-center gap-1.5 text-sm pl-4 border-l border-stone-400 dark:border-slate-600">
