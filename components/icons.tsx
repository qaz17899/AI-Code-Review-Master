...
export const MasterIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="var(--accent-color)" {...props}>
    {/* A futuristic, abstract representation of a tech cube or crystal */}
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9.75L3 7.5m9 5.25L21 7.5m-9 5.25v9.75" />
  </svg>
);
...
export const NavIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
  </svg>
);
...
export const TokenIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-1.5h5.25m-5.25 0h3m-3 0h-1.5m2.25-4.5H5.25m3 0H5.25m3 0h-1.5m2.25-4.5H5.25m3 0H5.25m3 0h-1.5m1.5-1.5H5.25m3 0H5.25m3 0h-1.5m9 15l-3-3m0 0l-3 3m3-3v-6m0 6h-3m3 0h3" />
  </svg>
);
...
export const RefactorIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-11.667 0l-3.181 3.183m0 0l-3.181-3.183m3.181-3.182l11.667 0m-11.667 0l-3.181-3.182m3.181 3.182L12 12.51m-4.993 4.993l-3.181-3.183m3.181 3.182h4.992m-4.992 0l-3.181-3.183" />
  </svg>
);
...
export const MessageSquareIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.388A5.887 5.887 0 0112 21a5.887 5.887 0 01-6.47-3.138A9.76 9.76 0 013 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
  </svg>
);
...
export const FolderOpenIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75h16.5m-16.5 0A2.25 2.25 0 015.25 7.5h5.379a1.5 1.5 0 011.06.44L12 9.75m-8.25 0a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h13.5a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44L12 7.5m0 0l-2.25 2.25M3.75 9.75V21a2.25 2.25 0 002.25 2.25h13.5A2.25 2.25 0 0021.75 21V9.75" />
  </svg>
);
...
export const TypeScriptIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#3178C6" {...props}>
        <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zM12 20.94l6.09-1.693.93-10.455h-4.27v3.235h-3.03V8.558h9.34l-.79 8.892L12 19.46v-3.235h3.03v-3.234H8.72l-.21-2.36h9.02L18.04 4H5.96l.87 9.773h4.27V11.23h3.03v3.235z"/>
    </svg>
);
export const JavaScriptIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#F7DF1E" {...props}>
        <path d="M0 0h24v24H0V0zm22.5 21H1.5V3h21v18zM12 18.25c-1.35 0-2.5-.5-3.32-1.32-.83-.83-1.32-1.97-1.32-3.32 0-1.35.5-2.5 1.32-3.32.83-.83 1.97-1.32 3.32-1.32 1.25 0 2.3.43 3.12 1.25l-1.4 1.43c-.47-.43-.9-.62-1.72-.62-.7 0-1.25.25-1.68.7-.44.44-.66 1.05-.66 1.8 0 .75.22 1.36.66 1.8.43.44 1 .66 1.68.66.82 0 1.25-.2 1.72-.63l1.4 1.43c-.82.82-1.87 1.25-3.12 1.25zm5.12-1.13h-2.25v-1.12l.2-.13c.43-.3.7-.56.84-.78.14-.22.21-.47.21-.75 0-.4-.14-.7-.4-.9-.26-.2-.6-.3-1.05-.3-.4 0-.75.07-1.03.22l-.5-.95c.4-.2.85-.3 1.5-.3.8 0 1.4.18 1.83.52.43.35.65.8.65 1.35 0 .4-.1.78-.3 1.1-.2.33-.53.7-1 1.07l-.7.5h2.13v1.13z"/>
    </svg>
);
export const JsonIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.5 13.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm3 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/>
    </svg>
);
export const HtmlIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#E34F26" {...props}>
        <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zM12 20.94l6.09-1.693.93-10.455h-4.27v3.235h-3.03V8.558h9.34l-.79 8.892L12 19.46v-3.235h3.03v-3.234H8.72l-.21-2.36h9.02L18.04 4H5.96l.87 9.773h4.27V11.23h3.03v3.235z"/>
    </svg>
);
...
export const DesignIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5M12 3.75v16.5M6 18L18 6M6 6l12 12" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18z" />
    </svg>
);

export const TesterIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 10.5l-5.25 5.25m0-5.25l5.25 5.25" />
    </svg>
);
...
export const BroomIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25c-5.187 0-9.443 4.02-9.73 9.165.23-.111.466-.213.708-.306 1.46-1.013 3.168-1.609 5.022-1.609 1.6 0 3.091.44 4.354 1.214.22.132.433.27.64.413-.331-5.098-4.59-9.04-9.994-9.04z" transform="rotate(45 12 12)" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 19.5L12 12" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12l-7.5 7.5" />
    </svg>
);
// FIX: Add missing icons for ModeIcons.tsx
export const BugAntIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 4.5L7.5 6" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 4.5l1.5 1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 19.5l-1.5-1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.5l1.5-1.5" />
  </svg>
);
...
export const ScaleIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 7.5 3 12.75h4.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 7.5 21 12.75h-4.5" />
...
export const ScissorsIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 16.5a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12L19.5 4.5m-7.5 7.5L4.5 19.5" />
  </svg>
);
...
export const WorkflowIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 12H18m-4.5-4.5l2.25 2.25L18 12l-2.25 2.25-2.25 2.25" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 12H6m4.5 4.5L8.25 14.25 6 12l2.25-2.25L10.5 7.5" />
    </svg>
);
